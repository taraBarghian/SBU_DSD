...
source tb/sim/mentor/msim_setup.tcl
# Suppress warnings from the std arithmetic libraries
set StdArithNoWarnings 1
set ELAB_OPTIONS "+nowarnTFMPC -dpioutoftheblue 1 -sv_lib \"D:/intelFPGA/19.1/hls/windows64/bin/hls_cosim_msim32\" -nodpiexports"
elab
onfinish {stop}
run -all
