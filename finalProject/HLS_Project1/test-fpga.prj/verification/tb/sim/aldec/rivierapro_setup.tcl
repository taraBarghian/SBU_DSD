...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../count_internal_10/sim/acl_enable_sink.v"                                                             -l altera_common_sv_packages -work tb_count_internal_10                       
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../count_internal_10/sim/acl_ffwdsrc.v"                                                                 -l altera_common_sv_packages -work tb_count_internal_10                       
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../count_internal_10/sim/acl_full_detector.v"                                                           -l altera_common_sv_packages -work tb_count_internal_10                       
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/../count_internal_10/sim/acl_loop_limiter.v"                                                            -l altera_common_sv_packages -work tb_count_internal_10                       
